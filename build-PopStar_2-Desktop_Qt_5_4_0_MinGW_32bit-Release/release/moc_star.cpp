...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Star_t, stringdata) + ofs \
...
const QMetaObject Star::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Star.data,
      qt_meta_data_Star,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Star::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Star.stringdata))
        return static_cast<void*>(const_cast< Star*>(this));
